...
import athletiic from './assets/products/athletic-cotton-socks-6-pairs.jpg';
      ...
      <div className="orders-grid">
        <div className="order-container">
          ...
          <div className="order-details-grid">
            ...
            <div className="product-image-container">
              <img src={adultsPlainCottonTshirt2PackTealImage} />
            </div>
        ...
        <div className="order-container">
          ...
          <div className="order-details-grid">
            <div className="product-image-container">
              <img src={intermediateCompositeBasketballImage} />
            </div>
